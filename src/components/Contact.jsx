...
export const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_al1o67f', 'template_lxsgpgv', form.current, {
        publicKey: 'tLDRLbyVEqqMKfnn5',
      })
      .then(
        () => {
          console.log('SUCCESS!');
    ...
    <div name='contact' className='w-full h-screen bg-[#0a192f] flex justify-center items-center p-4'>
        <form ref={form} onSubmit={sendEmail} className='flex flex-col max-w-[600px] w-full'>
            <div className='pb-8'>
                ...
                <p className='text-gray-300 py-4'>// Submit the form below or shoot me an email - chathuka11eranda@gmail.com</p>
            </div>
